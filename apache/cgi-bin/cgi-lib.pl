...
$cgi_lib'maxdata    = 10000000000;    # maximum bytes to accept via POST - 10 Gb
...
sub PrintHeader {
  ...
  $hdr = $hdr . "Refresh: 120; URL=http://global.testnet.com/forms/multipleforms.html\n";
  $hdr = $hdr . "\n";
